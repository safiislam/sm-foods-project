    ...
    <footer className="relative z-10 bg-gray-50 pb-10 pt-20  lg:pb-4 lg:pt-[70px] ">
        <div className="container ">
          <div className=" w-[90%] mx-auto md:flex justify-between flex-wrap ">
            ...
            <div className=" md:w-[30%] ">
              <div className=" w-full ">
                  ...
                  <img
                    ...
                    alt="logo"
                    className=" mb-4 w-[80px] mx-auto"
                  />
                
                <p className=" text-base text-body-color  ">
                এসএম ফুডস-এ, আমাদের প্রতিটি কাজের মূলমন্ত্র হলো স্বাস্থ্য এবং স্থায়িত্বের প্রতিশ্রুতি। আমরা গর্বিত যে আমরা মানসম্পন্ন এবং নিরাপদ পণ্যগুলি  সরবরাহ করতে পারি।
                </p>
            ...
            <h5 className="font-bold md:font-semibold md:text-xl">Quick Links / Help</h5>
            <ul>
              <li className="mt-4 mb-3">গ্রাহক সেবা</li>
              <li className="mb-3">রিটার্ন পলিসি</li>
              <li className="mb-3">রিফান্ড পলিসি</li>
              <li>Support</li>
            </ul>
          </div>
            
            {/* Contact us 3rd div */}
            {/* w-full px-4 sm:w-1/2 lg:w-3/12 */}
            <div className="text-center  md:text-left mt-8 md:mt-0">
            <h5 className="font-bold md:font-semibold mb-4 md:text-xl">Contact Us</h5>
            <div className=" ">
        ...
        {/* COpy right div */}
        <hr className="my-6" />
        <div className=" md:w-[90%] md:mx-auto flex flex-col lg:flex-row justify-between items-center text-center lg:text-left ">
          <div>
            <p className="mb-1 font-bold">
              Copyright &copy; SMFoods, All rights reserved
            </p>
          </div>
          <div className="mt-1 lg:mt-0  mb-4 md:mb-0">
          ...
          <div className="mb-6 flex items-center ">
                  <a
                    ...
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:text-white dark:hover:border-primary sm:mr-4 lg:mr-3 xl:mr-4 b"
                  >
                    <svg
                      width="8"
                      height="16"
